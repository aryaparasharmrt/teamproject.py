...
IFontDisp = Font
__all__ = [ 'IFont', 'OLE_COLOR', 'IPictureDisp',
           'OLE_YSIZE_CONTAINER', 'OLE_XPOS_PIXELS',
           'OLE_YSIZE_PIXELS', 'OLE_XPOS_CONTAINER', 'IPicture',
           'IFontDisp', 'VgaColor', 'OLE_XSIZE_HIMETRIC', 'Default',
           'FONTUNDERSCORE', 'Font', 'StdFont', 'OLE_XSIZE_CONTAINER',
           'FONTNAME', 'Color', 'LoadPictureConstants',
           'OLE_XSIZE_PIXELS', 'FONTSTRIKETHROUGH', 'StdPicture',
           'IFontEventsDisp', 'OLE_YPOS_HIMETRIC', 'FONTBOLD',
           'OLE_ENABLEDEFAULTBOOL', 'FONTSIZE', 'Unchecked',
           'OLE_OPTEXCLUSIVE', 'Gray', 'OLE_TRISTATE',
           'OLE_XPOS_HIMETRIC', 'OLE_YPOS_CONTAINER',
           'OLE_CANCELBOOL', 'OLE_YPOS_PIXELS', 'Monochrome',
           'FontEvents', 'OLE_YSIZE_HIMETRIC', 'Picture',
           'OLE_HANDLE', 'FONTITALIC', 'Checked']
